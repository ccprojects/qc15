	...
	<body>
		...
		<div id="show-restaurante" class="content scaffold-show" role="main">
			...
			<ol class="property-list restaurante">
				...
				<g:if test="${restauranteInstance?.disponibles}">
				<li class="fieldcontain">
					<span id="disponibles-label" class="property-label"><g:message code="restaurante.disponibles.label" default="Disponibles" /></span>
					
						<span class="property-value" aria-labelledby="disponibles-label"><g:fieldValue bean="${restauranteInstance}" field="disponibles"/></span>
				...
				<g:if test="${restauranteInstance?.reservados}">
				<li class="fieldcontain">
					<span id="reservados-label" class="property-label"><g:message code="restaurante.reservados.label" default="Reservados" /></span>
					
						<span class="property-value" aria-labelledby="reservados-label"><g:fieldValue bean="${restauranteInstance}" field="reservados"/></span>
